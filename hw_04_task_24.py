...
garden = list(random.randint(1, 50) for i in range(int(input('Введите кол-во кустов черники: '))))
print(garden)

neighborBushes = list()

for i in range(len(garden)-1):
    neighborBushes.append(garden[i-1] + garden[i] + garden[i+1])

neighborBushes.append(garden[-2] + garden[-1] + garden[0])

print(neighborBushes)
print(max(neighborBushes))
